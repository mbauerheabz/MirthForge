 ...
 * This file demonstrates how to integrate Mirthforge with a web frontend
 */

// For React/Vue/Angular applications
export class MirthforgeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new MirthforgeClient(provider, contractAddress);
